...
namespace BitPixel.DI
{
	public static class DependencyRegistrar
	{
		...
		{
			var dependencyResolver = new BitPixelDependencyResolver(_container.Kernel);
			var controllerFactory = new BitPixelControllerFactory(_container.Kernel);
