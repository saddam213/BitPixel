...
namespace DotMatrix.Datatables.Reflection
{
	internal static class DataTablesTypeInfo
	{
		static ConcurrentDictionary<Type, DataTablesPropertyInfo[]> propertiesCache =
			new ConcurrentDictionary<Type, DataTablesPropertyInfo[]>();
