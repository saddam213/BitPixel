...
using BitPixel.WalletService.Connector.DataObjects;
using BitPixel.WalletService.Connector.Helpers;
using Newtonsoft.Json;

namespace BitPixel.WalletService.Connector.Base
{
	/// <summary>
	...
	public class WalletConnector : Connector
	{
		...
		public WalletConnector(string host, string username, string password, int timeout = 60000)
	: base(host, username, password, timeout)
		{
		}
		/// <summary>
		...
		public string GenerateAddress(string accountId, bool allowMultiple)
		{
			if (!allowMultiple)
			{
		...
		/// <returns></returns>
		public Task<string> GenerateAddressAsync(string accountId, bool allowMultiple)
		{
			return Task.Factory.StartNew(() => GenerateAddress(accountId, allowMultiple));
		}
