...
AS
	...
	IF(@PixelId IS NULL)
		BEGIN
			...
			INSERT INTO [dbo].[Pixel]([UserId], [X], [Y], [Type], [Color], [Points], [LastUpdate])
			VALUES(@UserId, @X, @Y, @Type, @Color, @NewPixelPoints, @Timestamp)
	...
	INSERT INTO [dbo].[PixelHistory]([PixelId], [UserId], [Type], [Color], [Points], [Timestamp])
	VALUES(@PixelId, @UserId, @Type, @Color, @PixelPoints, @Timestamp)
